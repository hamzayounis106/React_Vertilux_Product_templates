...
export default function TechnicalProperties() {
  ...
  console.log("TechnicalProperties", acfData);
  return (
    <div className=" w-[100%]  flex justify-start items-center flex-col">
      <table className="w-[95%]">
        <tbody>
          <tr>
            <td className="w-[50%] text-[#58585A] capitalize text-[18px] font-[600] IBM">
              codigo
            </td>
            <td className="text-[#A6A6A8] w-[50%] text-[18px] text-[400] IBM">
              {acfData?.codigo}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="text-[#A6A6A8] w-[50%] text-[15px] text-[400] IBM">
              {acfData?.model}
            </td>
          </tr>{" "}
          <tr>
          ...
          <tr>
            <td className="text-[#A6A6A8] w-[50%] text-[10px] text-[400] IBM">
              {acfData?.note}
            </td>
          </tr>
        </tbody>
